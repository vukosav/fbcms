...
(function() {
  ...
  cardNumber.mount('#myCardForm-card-number');

  var cardExpiry = elements.create('cardExpiry', {
    style: elementStyles,
    classes: elementClasses,
  });
  cardExpiry.mount('#myCardForm-card-expiry');

  var cardCvc = elements.create('cardCvc', {
    style: elementStyles,
    classes: elementClasses,
  });
  cardCvc.mount('#myCardForm-card-cvc');
  registerElements([cardNumber, cardExpiry, cardCvc], 'myCardForm');
})();