...
class Ajax_pagination{
    ...
    var $last_link       = 'Last';
    var $uri_segment     = 3;
    var $full_tag_open   = '<div class="ht-80 bd d-flex align-items-center justify-content-center"> <nav aria-label="Page navigation"> <ul class="pagination pagination-basic pagination-primary mg-b-0">';
