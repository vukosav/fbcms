    ...
    <div class="kt-pagebody">
        <div class="card pd-20 pd-sm-40">
            <div class="form-group">
                ...
                <div id="modaldemo4" class="modal fade" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content tx-size-sm">
                            <div class="modal-header pd-x-20">
                            ...
                            <form name="formGroupName" action="<?= base_url() ?>updategroup" method="POST">
                                <div class="modal-body pd-20">
                                    <input type="text" name="groupname" class="col col-md-12 form-control" placeholder="Type grup name" required>
                                </div><!-- modal-body -->
                                <div id="hiden_polje">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-default pd-x-20">Edit
                                        group name</button>
                                    <button type="button" class="btn btn-secondary pd-x-20" data-dismiss="modal">Close</button>
                                </div>
                            </form>
                ...
                <div class="row form-group">
                    <div class="col col-sm-2">
                        <input type="text" class="form-control" id="grname" placeholder="Type group name" onkeyup="searchFilter()" />
                    </div>
                    <div class="col col-sm-2">
                    ...
                    <div class="col col-sm-1">
                        <a id="button" href="" onclick="resetform()" name="reset" value="Reset" class="btn  btn-icon rounded-circle" style='font-size: xx-large;' data-toggle="tooltip" data-placement="top" title="Reset filter"><i class="fa fa-refresh"></i></a>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="ShowEditModal('<?php echo $group['id']; ?>')" data-toggle="modal" data-target="#modaldemo4" group-text="<input type='hidden' name='grId' value='<?php echo $group['id']; ?>'>" href="" id="group_<?php echo $group['id']; ?>">
                                        <span class="fa fa-edit" style="font-size: xx-large;margin: 6px; color: #3b6998;" data-toggle="tooltip" data-placement="top" title="Edit group"></span></a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
        ...
        <script>
            function ShowEditModal(id) {
                ...
                document.getElementById("hiden_polje").innerHTML = document.getElementById("group_" + id)
