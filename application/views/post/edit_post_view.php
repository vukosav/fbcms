...
<div class="row">
    <div class="col-sm-5">
        <div class="panel panel-default">
            ...
            <?php echo form_open('fb_post/insert_post/' . $input_post_id); ?>
                ...
                <div class="formField titleField">
                    <label for="title">Post Title<a href="#"  onclick="return false;" data-toggle="kp_tooltip" data-placement="top" style="float:right" title="Spinning example : {Hello|Howdy|Hola} to you, {Mr.|Mrs.|Ms.} {foo|bar|foobar}!!"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                    <input type="text" id="postTitle" name="postTitle" class="form-control" placeholder="Working post title..."><?php $input_post_title; ; ?></input>
                </div>
                ...
                <div id="postImageDetails" <?php if ($input_post_type !== "image" ) {echo 'style="display:none"';}?> >
                    <div class="formField">
                        ...
                        <div class="multiImages">
                            ...
                            <?php 
                            if ($input_post_type === "image" ) //or $p_image[0] !=="")
                            {
                                /*
