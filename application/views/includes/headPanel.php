<div class="kt-headpanel">
            ...
            <div class="media-list">
              ...
              <a href="" class="media-list-link read">
                <div class="media pd-x-20 pd-y-15">
                  <img src="<?=base_url()?>theme/img/img8.jpg" class="wd-40 rounded-circle" alt="">
              ...
              <a href="" class="media-list-link read">
                <div class="media pd-x-20 pd-y-15">
                  <img src="<?=base_url()?>theme/img/img9.jpg" class="wd-40 rounded-circle" alt="">
                  <div class="media-body">
              ...
              <a href="" class="media-list-link read">
                <div class="media pd-x-20 pd-y-15">
                  <img src="<?=base_url()?>theme/img/img10.jpg" class="wd-40 rounded-circle" alt="">
                  <div class="media-body">
              ...
              <a href="" class="media-list-link read">
                <div class="media pd-x-20 pd-y-15">
                  <img src="<?=base_url()?>theme/img/img5.jpg" class="wd-40 rounded-circle" alt="">
                  <div class="media-body">
    ...
    <div class="kt-breadcrumb">
      <nav class="breadcrumb">
        <a class="breadcrumb-item" href="<?=base_url()?>">Datadata</a>
