      ...
      <ul class="nav kt-sideleft-menu">
        ...
        <li class="nav-item">
          ...
          <ul class="nav-sub">
            ...
            <li class="nav-item"><a href="edit-profile.html" class="nav-link active">Edit Profile</a></li>
            ...
            <div class="card bg-gray-200 bd-0">
              <div class="edit-profile-form">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8 col-xl-6 mg-t-10 mg-sm-t-0">
                    <input class="form-control" placeholder="Enter Portfolio URL" type="text" value="http://themepixels.me">
                  </div>
                </div><!-- form-group -->
                <div class="form-group row mg-b-0">
